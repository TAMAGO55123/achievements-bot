...
ACHIEVEMENTS = {
    ...
    "i_know_nothing": {"name": "僕は何も知らない", "description": "「知らない」と発言する。", "is_hidden": False},
    "rebellion_god": {"name": "神への反逆", "description": "実績botに対して返信する。", "is_hidden": False},
    "tamaya": {"name": "たーまやー", "description": "「爆死」を含む発言をする。", "is_hidden": False},
    "anta_baka": {"name": "あんたばかぁ？", "description": "ユーザーがユーザー自身をメンションする。", "is_hidden": False},
    "self_intro_first": {"name": "まずは事故紹介から", "description": "事故紹介chで発言する。", "is_hidden": False},
    "good_night": {"name": "Good night", "description": "21-2時の間に「おやすみ」と発言する。", "is_hidden": False},
    "seichi": {"name": "整地してくるわ", "description": "「マイクラ」、「マインクラフト」を含む発言をする。（英語も可）", "is_hidden": False},
    "not_sleepy": {"name": "眠くないの？", "description": "深夜4時-6時の間に「おはよう」と発言する。", "is_hidden": False},
    "hanshin": {"name": "なんでや！阪神関係ないやろ！", "description": "「33-4」または「334」を含む発言をする。", "is_hidden": False},
    "saba_no_inochi": {"name": "鯖主の命", "description": "「ストゼロ」「ストロングゼロ」を発言する。", "is_hidden": False},
    "reach": {"name": "R'E'A'C'H'", "description": "「お手を拝借」と発言する。", "is_hidden": False},
    "past_mistake": {"name": "消えぬ過ち", "description": "「じろりんぐ」「ziroring」を発言する。", "is_hidden": False},
    "rariat_no_ne_yo": {"name": "らりあっとじゃねぇよ", "description": "「わっしょいらりあっと」を発言する。", "is_hidden": False},
    "good_reaction": {"name": "いいね", "description": "発言に👍のリアクションをする。", "is_hidden": False},
    "eat_rice": {"name": "飯を食え、飯を", "description": "飯テロchで画像を送信する。", "is_hidden": False},
    "before_after": {"name": "悲劇的ビフォーアフター", "description": "「解体」と発言する。", "is_hidden": False},
    "cv_unimpl": {"name": "CV未実装", "description": "2名以上いるVCで2時間ミュート状態でいる。", "is_hidden": False},
    "everyone_8pm": {"name": "8時だョ！全員集合", "description": "土曜日20時ちょうどにVCに6人以上入っている状態の場合付与。", "is_hidden": False},
    "dont_run": {"name": "逃げるな", "description": "「ノーツが抜けた」と発言する。", "is_hidden": False},
    "what_diary": {"name": "どんな日記だよ", "description": "特定のテキストを含むメッセージを送信する。", "is_hidden": False},
    "public_washer": {"name": "公認洗濯機", "description": "「maimai」を含むテキストを送信。", "is_hidden": False},
    "maimai_q": {"name": "maimai?", "description": "「洗濯機」を含むテキストを送信。", "is_hidden": False},
    "gekichumai": {"name": "ゲキチュウマイ！！！", "description": "「オンゲキ」「CHUNITHM」「maimai」のいずれかを含むテキストを送信。", "is_hidden": False},
    "ojou_janai": {"name": "お嬢じゃないなり", "description": "「お嬢」「ゆーと嬢」のどちらかを含むテキストを送信。", "is_hidden": False},
    "folern": {"name": "folern", "description": "「ｺﾝｽｨｰﾔ」を含むテキストを送信。", "is_hidden": False},
    "happy_birthday": {"name": "Happybirthday!!!!", "description": "「誕生日」を含むテキストを送信。", "is_hidden": False},
    "buy_anger_2": {"name": "だから怒りを買うよって", "description": "「玄米」を含むテキストを送信。", "is_hidden": False},
    "cockroach": {"name": "いやあああぁぁぁぁぁぁぁ", "description": "「ゴキブリ」を含むテキストを送信。", "is_hidden": False},
    "sleep_early": {"name": "さっさと寝ろ", "description": "「ねむい」と24時間以内に5回言う。", "is_hidden": False},
    "louder": {"name": "もっと大きな声で！", "description": "-#で始まる文章を3回送る。", "is_hidden": False},
    "english_pro": {"name": "英語ペラペラ？", "description": "英数字および半角記号のみで構成された50文字以上の文章を送る。", "is_hidden": False},
    ...
    "minecraft_suru": {"name": "マイクラする？", "description": "憧憬管理委員会 (bot) をメンションする。", "is_hidden": True},
    "tasogare_shoukei": {"name": "黄昏時の憧憬", "description": "「限界を超えた先にある不屈の精神」と発言する。", "is_hidden": True},
    "folern_kanzen": {"name": "folern完全詠唱", "description": "コンスィーヤの歌詞を送信する。", "is_hidden": True},
    "tutorial_finish": {"name": "黄昏時の憧憬。チュートリアルフィニッシュ", "description": "累計10000テキストを送信する。", "is_hidden": True},
    "and_then_there_were_none": {"name": "そして何も無くなった", "description": "15分以内に20個以上のテキストを消す。", "is_hidden": True},
    "ohisashiburi": {"name": "お久しぶりです", "description": "1週間テキストを送信してない状態でテキストを送信する。", "is_hidden": True},
    "not_a_game": {"name": "ゲームじゃないです", "description": "↑↓↑↓←→←→BA と送信する。", "is_hidden": True},
    "you_free": {"name": "あなた暇なの？", "description": "VCに連続24時間入る。", "is_hidden": True},
    }